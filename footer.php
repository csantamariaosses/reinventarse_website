...
<div class="container-fluid footer_csanta">
   ...
   <div class="row mt-1">
      <div class="col-sm-5 col-xs-12">
         ...
         <div class="textoFooterDireccion"><img src="<?php echo $PATH_IMAGES?>/reinventarseTelefono.png" width="15px">&nbsp;&nbsp;(+562) 2 365 32 76 </div>
         <div class="textoFooterDireccion"><img src="<?php echo $PATH_IMAGES?>/email.png" width="15px">&nbsp;&nbsp;contacto@reinventarse.cl</div>
      </div>
      ...
      <img src="<?php echo $PATH_IMAGES?>/reinventarseLogoFacebook.png" width="50px"><br><br>   
